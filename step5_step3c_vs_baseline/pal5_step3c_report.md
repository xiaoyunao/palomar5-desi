...
- Baseline run: **step5 empirical bg + MAP**
- eta_mode: `unknown`
- sampler: `map`
...
| integrated stars, |phi1| < 8 | 3734 | 2872 | 3000 |
| trailing / leading, |phi1| < 8 | 0.91 | 1.68 | ~1.0 |
| trailing / leading, |phi1| < 5 | 1.78 | 1.75 | 1.50 |
| near-cluster width [deg] | 0.116 | 0.118 | 0.150 |
| leading max width in [5, 8] [deg] | 1.200 @ 7.75 | 0.287 @ 7.00 | 0.400 @ 7.0 |
| trailing max width in [-15, -5] [deg] | 1.200 @ -14.00 | 0.554 @ -10.25 | trailing should stay relatively thin |
