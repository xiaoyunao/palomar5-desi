...
- Baseline run: **step4c RRL prior + control + MAP**
- eta_mode: `control`
- sampler: `map`
- Strict sample size: 456496
...
|---|---:|---:|---:|
| successful bins | 40 | 39 | 41 bins modeled |
| successful bins excluding cluster | 38 | 37 | -- |
| trailing extent [deg] | 20.00 | 19.25 | 16.0 |
| leading extent [deg] | 9.25 | 9.25 | 8.0 |
| integrated stars, |phi1| < 8 | 2960 | 2872 | 3000 |
| trailing / leading, |phi1| < 8 | 1.50 | 1.68 | ~1.0 |
| trailing / leading, |phi1| < 5 | 1.64 | 1.75 | 1.50 |
| near-cluster width [deg] | 0.120 | 0.118 | 0.150 |
| leading max width in [5, 8] [deg] | 0.301 @ 7.00 | 0.287 @ 7.00 | 0.400 @ 7.0 |
| trailing max width in [-15, -5] [deg] | 0.535 @ -10.25 | 0.554 @ -10.25 | trailing should stay relatively thin |
